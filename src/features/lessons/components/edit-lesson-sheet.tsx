...
export function EditLessonSheet({ lesson, open, onOpenChange }: { lesson: Lesson, open: boolean, onOpenChange: (open: boolean) => void }) {
 ...
 {/* Extracting Overlay */}
 {isExtracting && (
 <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-background/95 dark:bg-[#0c0c14]/95 backdrop-blur-sm animate-in fade-in duration-300">
