    ...
    <div className="relative w-full max-w-[420px]">
      ...
      <div className="relative rounded-3xl bg-[#0c0c14]/95 backdrop-blur-2xl border border-white/[0.06] shadow-2xl overflow-hidden">
        ...
        <div className="p-8 pt-7">
          ...
          {/* Google — primary CTA */}
          <Button
            className="w-full h-11 rounded-xl font-semibold text-[13px] bg-white hover:bg-white/90 text-[#1a1a2e] border-0 shadow-md shadow-white/5 hover:shadow-white/10 transition-all duration-300 gap-2.5 cursor-pointer mb-5"
